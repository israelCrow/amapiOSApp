//
//  ArchivedPitchEvaluationView.swift
//  Amap
//
...
class ArchivedPitchEvaluationView: UIView {
  ...
  var delegate: ArchivedPitchEvaluationViewDelegate?
  ...
  private func createCanceledImageView() {
    ...
    let canceledImageViewFrame = CGRect.init(x: (self.frame.size.width / 2.0) - (canceledImageView.frame.size.width / 2.0),
                                             y: (85.0 * UtilityManager.sharedInstance.conversionHeight),
  ...
  private func createMessageLabel() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.ArchivedPitchEvaluationView.canceledMessageLabelText,
  ...
  private func createDetailedMessageLabel() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.ArchivedPitchEvaluationView.detailedMessageLabelText,
      attributes:[NSFontAttributeName: font!,
        NSParagraphStyleAttributeName: style,
        NSForegroundColorAttributeName: color
      ]
  ...
  @objc private func nextButtonPressed() {
    ...
    self.delegate?.nextButtonPressedFromArchivedPitchEvaluationView(self)
