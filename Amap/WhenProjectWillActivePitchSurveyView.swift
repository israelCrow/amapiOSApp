//
//  WhenProjectWillActivePitchSurveyView.swift
//  Amap
//
...
protocol WhenProjectWillActivePitchSurveyViewDelegate {
...
class WhenProjectWillActivePitchSurveyView: UIView, UITextFieldDelegate {
  ...
  private func createTitleLabel() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: "¿Cuándo se activará?", //EditPitchesConstants.DidSignContactPitchSurveyView.titleLabelText,
      attributes:[NSFontAttributeName: font!,
        NSParagraphStyleAttributeName: style,
  ...
  private func createWriteDateOfCreationOfPitchView() {
    ...
    whenProjectWillActiveView = CustomTextFieldWithTitleView.init(frame: frameForView,
    ...
    self.addSubview(whenProjectWillActiveView)
