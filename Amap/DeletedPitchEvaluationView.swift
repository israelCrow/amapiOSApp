//
//  DeletedPitchEvaluationView.swift
//  Amap
//
...
protocol DeletedPitchEvaluationViewDelegate {
  
  func nextButtonPressedFromDeletedPitchEvaluationView(sender: DeletedPitchEvaluationView)
  
}

class DeletedPitchEvaluationView: UIView {
  
  private var declinedImageView: UIImageView! = nil
  private var messageLabel: UILabel! = nil
  private var detailedMessageLabel: UILabel! = nil
  private var nextButton: UIButton! = nil
  
  var delegate: DeletedPitchEvaluationViewDelegate?
  ...
  private func createDeclinedImageView() {
    
    declinedImageView = UIImageView.init(image: UIImage.init(named: "eliminarIcon"))
    let canceledImageViewFrame = CGRect.init(x: (self.frame.size.width / 2.0) - (declinedImageView.frame.size.width / 2.0),
                                             y: (102.0 * UtilityManager.sharedInstance.conversionHeight),
    ...
    self.addSubview(declinedImageView)
  ...
  private func createMessageLabel() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.DeletedPitchEvaluationView.canceledMessageLabelText,
    ...
    let newFrame = CGRect.init(x: (self.frame.size.width / 2.0) - (messageLabel.frame.size.width / 2.0),
                               y: 209.0 * UtilityManager.sharedInstance.conversionHeight,
  ...
  private func createDetailedMessageLabel() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.DeletedPitchEvaluationView.detailedMessageLabelText,
      attributes:[NSFontAttributeName: font!,
        NSParagraphStyleAttributeName: style,
        NSForegroundColorAttributeName: color
      ]
  ...
  private func createNextButton() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.DeletedPitchEvaluationView.nextButtonText,
      attributes:[NSFontAttributeName: font!,
        NSParagraphStyleAttributeName: style,
  ...
  @objc private func nextButtonPressed() {
    ...
    self.delegate?.nextButtonPressedFromDeletedPitchEvaluationView(self)
