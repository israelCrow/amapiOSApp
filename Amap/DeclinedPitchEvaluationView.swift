//
//  DeclinedPitchEvaluationView.swift
//  Amap
//
...
class DeclinedPitchEvaluationView: UIView {
  ...
  var delegate: DeclinedPitchEvaluationViewDelegate?
  ...
  private func createMessageLabel() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.DeclinedPitchEvaluationView.canceledMessageLabelText,
  ...
  private func createDetailedMessageLabel() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.DeclinedPitchEvaluationView.detailedMessageLabelText,
      attributes:[NSFontAttributeName: font!,
        NSParagraphStyleAttributeName: style,
        NSForegroundColorAttributeName: color
      ]
  ...
  private func createNextButton() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.DeclinedPitchEvaluationView.nextButtonText,
      attributes:[NSFontAttributeName: font!,
        NSParagraphStyleAttributeName: style,
  ...
  @objc private func nextButtonPressed() {
    ...
    self.delegate?.nextButtonPressedFromDeclinedPitchEvaluationView(self)
