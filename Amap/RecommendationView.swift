...
protocol RecommendationViewDelegate {
...
class RecommendationView: UIView {
  ...
  var delegate: RecommendationViewDelegate?
  ...
  private func createTitleLabel() {
    ...
    let frameForLabel = CGRect.init(x: 0.0,
                                    y: 0.0,
                                    width: 258.0 * UtilityManager.sharedInstance.conversionWidth,
                                    height: CGFloat.max)
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.RecommendationView.titleLabelText,
  ...
  private func createMessageLabel() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.RecommendationView.messageLabelText,
      attributes:[NSFontAttributeName: font!,
        NSParagraphStyleAttributeName: style,
        NSForegroundColorAttributeName: color
      ]
  ...
  private func createNextButton() {
    ...
    let stringWithFormat = NSMutableAttributedString(
      string: EditPitchesConstants.RecommendationView.nextButtonText,
      attributes:[NSFontAttributeName: font!,
        NSParagraphStyleAttributeName: style,
        NSForegroundColorAttributeName: color
      ]
  ...
  @objc private func nextButtonPressed() {
    ...
    self.delegate?.recommendationNextButtonPressed()
